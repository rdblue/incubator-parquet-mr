 ...
 */
public class DeltaZigZagIntValuesReader extends ValuesReader {
  private VariableWidthRLEDecoder decoder;
  ...
  public void initFromPage(int valueCount, ByteBuffer page, int offset) throws IOException {
    ...
    this.decoder = new VariableWidthRLEDecoder(in);
    this.lastValue = 0;
  ...
  public int readInteger() {
    try {
      int delta = ZigZagTransforms.Ints.decode(decoder.readInt());
