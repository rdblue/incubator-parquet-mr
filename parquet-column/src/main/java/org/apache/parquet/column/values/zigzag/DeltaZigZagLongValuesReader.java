 ...
 */
public class DeltaZigZagLongValuesReader extends ValuesReader {
  private VariableWidthLongRLEDecoder decoder;
  ...
  public void initFromPage(int valueCount, ByteBuffer page, int offset) throws IOException {
    ...
    this.decoder = new VariableWidthLongRLEDecoder(in);
    this.lastValue = 0;
  ...
  public long readLong() {
    try {
      long delta = ZigZagTransforms.Longs.decode(decoder.readLong());
