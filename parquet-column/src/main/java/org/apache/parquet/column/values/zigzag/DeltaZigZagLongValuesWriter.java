 ...
 */
public class DeltaZigZagLongValuesWriter extends ValuesWriter {
  private final VariableWidthLongRLEEncoder encoder;
  private long lastValue = 0L;

  public DeltaZigZagLongValuesWriter(int initialCapacity, int pageSize, ByteBufferAllocator allocator) {
  ...
  public void writeLong(long v) {
    try {
      long delta = lastValue - v;
      this.lastValue = v;
      encoder.writeLong(ZigZagTransforms.Longs.encode(delta));
    } catch (IOException e) {
