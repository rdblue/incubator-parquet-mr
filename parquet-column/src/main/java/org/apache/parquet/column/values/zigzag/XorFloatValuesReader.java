 ...
 */
public class XorFloatValuesReader extends ValuesReader {
  private VariableWidthRLEDecoder exponentDecoder;
  private VariableWidthRLEDecoder mantissaDecoder;
  ...
  public void initFromPage(int valueCount, ByteBuffer page, int offset) throws IOException {
    ...
    this.mantissaDecoder = new VariableWidthRLEDecoder(in);
  ...
  public float readFloat() {
    try {
      int mantissa = lastMantissaBits ^ mantissaDecoder.readInt();
      float f = ZigZagTransforms.Floats.decode(
