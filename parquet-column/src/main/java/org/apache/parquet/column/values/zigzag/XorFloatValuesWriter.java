 ...
 */
public class XorFloatValuesWriter extends ValuesWriter {
  private final VariableWidthRLEEncoder exponentEncoder;
  private final VariableWidthRLEEncoder mantissaEncoder;
  private int lastMantissaBits = 0;

  public XorFloatValuesWriter(int initialCapacity, int pageSize, ByteBufferAllocator allocator) {
  ...
  public void writeFloat(float v) {
    try {
      ...
      int mantissa = ZigZagTransforms.Floats.encodeMantissa(bits);
      mantissaEncoder.writeInt(lastMantissaBits ^ mantissa);
