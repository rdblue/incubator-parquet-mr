 ...
 */
public class ZigZagDoubleValuesWriter extends ValuesWriter {
  private final VariableWidthRLEEncoder exponentEncoder;
  private final VariableWidthLongRLEEncoder mantissaEncoder;

  public ZigZagDoubleValuesWriter(int initialCapacity, int pageSize, ByteBufferAllocator allocator) {
  ...
  public void writeDouble(double v) {
    try {
      ...
      mantissaEncoder.writeLong(ZigZagTransforms.Doubles.encodeMantissa(bits));
    } catch (IOException e) {
