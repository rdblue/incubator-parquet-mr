 ...
 */
public class ZigZagIntValuesWriter extends ValuesWriter {
  private final VariableWidthRLEEncoder encoder;

  public ZigZagIntValuesWriter(int initialCapacity, int pageSize, ByteBufferAllocator allocator) {
  ...
  public void writeInteger(int v) {
    try {
      encoder.writeInt(ZigZagTransforms.Ints.encode(v));
    } catch (IOException e) {
